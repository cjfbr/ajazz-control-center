...
inline QHash<QString, QString> deviceMaturityByCodename() {
    return QHash<QString, QString>{
        ...
        {QStringLiteral("hsv293s"), QStringLiteral("scaffolded")},
        ...
        {QStringLiteral("akp03e_rev2"), QStringLiteral("functional")},
        ...
        {QStringLiteral("mirabox_n3_6602_1000"), QStringLiteral("scaffolded")},
        {QStringLiteral("soomfon_stc_se"), QStringLiteral("scaffolded")},
        {QStringLiteral("msd_two"), QStringLiteral("scaffolded")},
        {QStringLiteral("treaslin_n3"), QStringLiteral("scaffolded")},
        {QStringLiteral("redragon_ss551"), QStringLiteral("scaffolded")},
