...
<!-- BEGIN AUTOGEN: stats -->
**40 devices** across 1 dongle, 3 keyboard, 10 mouse, 26 streamdeck — 11 functional, 25 scaffolded, 2 probed, 2 partial.
<!-- END AUTOGEN: stats -->
...
|--------|--------|---------|:----:|:--------:|--------|--------------|
| streamdeck | [AJAZZ AKP153](docs/protocols/streamdeck/akp153.md) | `0x5548:0x6674` | 15 | 0 | 🟢 functional | display, rgb, macros, firmware, clock |
| streamdeck | [Mirabox HSV293S](docs/protocols/streamdeck/akp153.md) | `0x5548:0x6670` | 15 | 0 | 🟡 scaffolded | display, rgb, macros, firmware, clock |
...
|--------|-----|--------|----------|-------|
| [AJAZZ AKP153](docs/protocols/streamdeck/akp153.md) | `0x5548:0x6674` | 🟢 functional | Per-key display, RGB backlight, Macros, Firmware version, Host-settable clock (scaffolded) | Reference 3x5 grid; 85x85 JPEG keys (Rot90+mirror). Canonical USB pair per ajazz-sdk and opendeck-akp153. |
| [Mirabox HSV293S](docs/protocols/streamdeck/akp153.md) | `0x5548:0x6670` | 🟡 scaffolded | Per-key display, RGB backlight, Macros, Firmware version, Host-settable clock (scaffolded) | Mirabox-branded AKP153 (opendeck-akp153 catalogue, 0x5548:0x6670). Same backend; the AKP153 row previously claimed to cover it under the wrong VID:PID. |
| [AJAZZ AKP153E](docs/protocols/streamdeck/akp153.md) | `0x0300:0x1010` | 🟢 functional | Per-key display, RGB backlight, Macros, Firmware version, Host-settable clock (scaffolded) | Canonical AKP153E PID per ajazz-sdk and opendeck-akp153; same protocol as AKP153. |
...
| [AJAZZ AKP03](docs/protocols/streamdeck/akp03.md) | `0x0300:0x1001` | 🟢 functional | Per-key display, Encoder / dial, Macros, Host-settable clock (scaffolded) | Canonical AKP03 pair per ajazz-sdk and opendeck-akp03. Registered as AKP153 until 2026-08-21, which opened it with protocol-version-1 (512-byte) framing so the device never responded. |
...
| [AJAZZ AKP03E](docs/protocols/streamdeck/akp03.md) | `0x0300:0x1002` | 🟢 functional | Per-key display, Encoder / dial, Macros, Host-settable clock (scaffolded) | Canonical AKP03E pair per ajazz-sdk and opendeck-akp03; protocol_version 2, 60x60 (Rot0) keys. Registered as AKP153E until 2026-08-21, which opened it with protocol-version-1 (512-byte) framing so the device never responded. |
| [AJAZZ AKP03E rev. 2](docs/protocols/streamdeck/akp03.md) | `0x0300:0x3002` | 🟢 functional | Per-key display, Encoder / dial, Macros, Host-settable clock (scaffolded) | Second-revision AKP03E silicon. Per opendeck-akp03 this is a protocol_version 3 device (both press and release edges) with 64x64 (Rot90) keys, not the 60x60 (Rot0) of the original. Carried the `akp03e` codename and protocol_version 2 until 2026-08-21. HARDWARE 2026-08-24 (firmware V3.AKP03E_PXL.02.010, serial 81D0DA78283D, `HOTSPOTEKUSB HOTSPOTEKUSB HID DEMO`, owner-confirmed 6 LCD keys + 3 encoders + 3 plain buttons): opens at protocol_version 3, reports firmware, renders all six LCD keys, brightness live. Input CONFIRMED WORKING for all 6 LCD keys, 3 plain buttons and 3 encoders, with codes matching opendeck-akp03 exactly — but ONLY after the device is initialized; a freshly-connected handle sends nothing on any interface. Note the white-label string does not identify the family (0x3004 carries it too and is a 10-key AKP05E); this unit was identified from the hardware. See akp03.md for the proof chain. |
...
| [Mirabox N3 (6602:1000)](docs/protocols/streamdeck/mirabox_n3.md) | `0x6602:0x1000` | 🟡 scaffolded | Per-key display, Encoder / dial, Macros, Host-settable clock (scaffolded) | Mirabox N3 USB pair from the opendeck-akp03 catalogue that this project had never registered. protocol_version 2. |
| [Soomfon Stream Controller SE](docs/protocols/streamdeck/akp03.md) | `0x1500:0x3001` | 🟡 scaffolded | Per-key display, Encoder / dial, Macros, Host-settable clock (scaffolded) | Licensee rebadge of the AKP03 / N3 board (opendeck-akp03 catalogue). protocol_version 3. |
| [Mars Gaming MSD-TWO](docs/protocols/streamdeck/akp03.md) | `0x0b00:0x1001` | 🟡 scaffolded | Per-key display, Encoder / dial, Macros, Host-settable clock (scaffolded) | Licensee rebadge of the AKP03 / N3 board (opendeck-akp03 catalogue). protocol_version 3. |
| [TreasLin N3](docs/protocols/streamdeck/akp03.md) | `0x5548:0x1001` | 🟡 scaffolded | Per-key display, Encoder / dial, Macros, Host-settable clock (scaffolded) | Licensee rebadge of the AKP03 / N3 board (opendeck-akp03 catalogue). protocol_version 3. |
| [Redragon Skyrider SS-551](docs/protocols/streamdeck/akp03.md) | `0x0200:0x2000` | 🟡 scaffolded | Per-key display, Encoder / dial, Macros, Host-settable clock (scaffolded) | Licensee rebadge of the AKP03 / N3 board (opendeck-akp03 catalogue). protocol_version 3. |
